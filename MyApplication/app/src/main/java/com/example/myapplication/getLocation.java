...
public class getLocation extends AppCompatActivity
{
  ...
  protected void onCreate(Bundle savedInstanceState)
  {
    ...
    setContentView(R.layout.get_my_loc);
    ...
    Button ShowLocationButton = (Button) findViewById(R.id.get_button);
    ...
    if (permsRequestCode == PERMISSIONS_REQUEST_CODE
      ...
      if (check_result) {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])
          ...
          Toast.makeText(getLocation.this, "퍼미션이 거부되었습니다. 앱을 다시 실행하여 퍼미션을 허용해주세요.",
          ...
          Toast.makeText(getLocation.this, "퍼미션이 거부되었습니다. 설정(앱 정보)에서 퍼미션을 허용해야 합니다. ",
              Toast.LENGTH_LONG).show();
